...
La tasa de resolución corresponde a la relación entre las garantías que se generan y aquellas que se van resolviendo para cada patología.\

Interpretación de los valores:

- Positivos: se resuelven más garantías de los que ingresan.
- Neutros: se resuelve la misma cantidad de las que entran.
